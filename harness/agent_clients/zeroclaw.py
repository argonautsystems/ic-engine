...
consolidated to TYPHON with `zeroclaw-demo-typhon` Docker container
(image `ghcr.io/perlowja/nclawzero-demo:master-...`) as the canonical
runtime; the older SSH-to-zeropi/clawpi path stopped applying after the
...
class ZeroClawClient(CLIAgentAdapter):
    ...
    def __init__(
        ...
        container = os.getenv("ZEROCLAW_CONTAINER", "zeroclaw-demo-typhon")
        super().__init__(
            agent_name="zeroclaw",
            command_template=[
                "docker",
