...
- **InvestorClaw v4.x (recommended)** — containerized application service via `ncz-os/mnemos-ic-runtime`. Exposes 20 MCP tools over HTTP at `:18090` and a 17-tab browser dashboard at `:18092`. Image: `ghcr.io/argonautsystems/ic-engine:4.6.0-cpu`. This is the primary path for end users.
