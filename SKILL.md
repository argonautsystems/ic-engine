...
user-invocable: true
metadata: {"license":"MIT-0","version":"4.6.0","image":"ghcr.io/argonautsystems/ic-engine:4.6.0-cpu","mcp-endpoint":"http://localhost:18090/mcp","transport":"streamable-http"}
---
...
# InvestorClaw — portfolio analysis skill (v4.6.0)
...
Agent: portfolio_version_check → "v4.6.0 available; you're on v4.4.2"
User:  "Upgrade me."
...
- Image: `ghcr.io/argonautsystems/ic-engine:4.6.0-cpu@sha256:c36afea2d6a92c036053443f641163e7ca7c6c152a410de819546047bf60f241` (multi-arch amd64+arm64; also at `:latest`)
